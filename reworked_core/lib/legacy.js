...
function PN_API(setup) {
    ...
    //
    //
    var pubnubInstance = new _main.PubNub();
    ...
    function _publish(next) {
        ...
        networking.performHTTP(PUB_QUEUE.shift());
    }
    ...
    var SELF = {
        ...
        'time': function time(callback) {
            ...
            networking.getServerTime(UUID, AUTH_KEY, instanceId, params, callback);
        },
        ...
        'subscribe': function subscribe(args, callback) {
            ...
            function _connect() {
                ...
                SUB_RECEIVER = networking.performHTTP({
                    timeout  : sub_timeout,
                    callback : jsonp,
